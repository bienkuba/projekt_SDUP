...
HD_PWD='C:/Users/czlow/OneDrive/Dokumenty/GitHub/projekt_SDUP/Turbocody/Turbocody.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Turbocode_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Turbocode_top.tcl -notrace
