...
HD_PWD='C:/Users/czlow/OneDrive/Dokumenty/GitHub/projekt_SDUP/Turbocody/Turbocody.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Turbocode_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Turbocode_top.tcl
